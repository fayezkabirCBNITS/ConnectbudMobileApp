...
import { makePostRequestMultipart, makeAuthGetRequest, makePostRequest } from '../../services/http-connectors'
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View style={styles.form}>
                        ...
                        <View style={styles.selectBtnDiv}>
                            <TouchableOpacity
                                style={this.state.fourCourse ? styles.ActiveSelectBtn : styles.selectBtn}
                                onPress={() => this.fetchFour('four')}
                            >
                                <Text
                                    style={this.state.fourCourse ? styles.ActiveSelectBtnText : styles.selectBtnText}
                                >
                                    4 Classes
                                </Text>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity
                                style={this.state.tenCourse ? styles.ActiveSelectBtn : styles.selectBtn}
                                onPress={() => this.fetchTen('ten')}
                            >
                                <Text
                                    style={this.state.tenCourse ? styles.ActiveSelectBtnText : styles.selectBtnText}
                                >
                                    10 Classes
                                </Text>
                            </TouchableOpacity>
                        ...
                        {/* Start Choose a course Tab */}
                        {
                            this.state.fourCourse && (
                                <View>
                                    <Text style={[styles.classText, { marginLeft: 5 }]}>Choose a course</Text>
                                    <View style={styles.selectCourseDiv}>
                                        {this.state.four.length > 0 && this.state.four.map((item, idx) => (
                                            <TouchableOpacity
                        ...
                        {this.state.tenCourse && (
                            <View>
                                <Text style={[styles.classText, { marginLeft: 5 }]}>Choose a course</Text>
                                <View style={styles.selectCourseDiv}>
                                    {this.state.ten.length > 0 && this.state.ten.map((item, idx) => (
                                        <TouchableOpacity
                                            // style={styles.courseBtn}
                                            style={this.state.ActiveId == item.id ? styles.AcourseBtn : styles.courseBtn}
                                            key={idx}
                            ...
                            this.state.TensyllabusTab && (
                                <View>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        ...
                                        <View style={styles.selectBtnDiv}>
                                            <TouchableOpacity
                                                style={this.state.ConnectBud ? styles.ActiveSelectBtn : styles.selectBtn}
                                                onPress={() => this.handlehireBy('connectBud')}
                                            >
                                                <Text
                                                    style={this.state.ConnectBud ? styles.ActiveSelectBtnText : styles.selectBtnText}
                                                >
                                                    ConnectBud
                                                </Text>
                                            </TouchableOpacity>
                                            ...
                                            <TouchableOpacity
                                                style={this.state.ChooseByOwn ? styles.ActiveSelectBtn : styles.selectBtn}
                                        ...
                                        {this.state.errHireBy === true ? (<ErrorMsg errorMsg="Please select one" />) : (<></>)}
                                    </View>

                                    <View>
                                        <Text style={styles.syllabusHeader}>Course Details of {this.state.tenSyllabus[0].course_name}</Text>
                                        <View style={styles.syllabus}>
                                            <Text style={styles.syllabusText}>Class duration : <Text style={styles.boldText}>{this.state.tenSyllabus[0].course_duration} hrs.</Text></Text>
                                            <Text style={styles.syllabusText}>Course amount: : <Text style={styles.boldText}>${this.state.tenSyllabus[0].total_amount}</Text></Text>
                                            <Text style={styles.syllabusText}>Number of classes : <Text style={styles.boldText}>{this.state.tenSyllabus[0].Number_of_classes}</Text></Text>
                                            ...
                                            {this.state.errStartTime === true ? (<ErrorMsg errorMsg="Please select Time" />) : (<></>)}
                        ...
                        {/* Start 4 Class syllabus */}
                        {
                            this.state.FoursyllabusTab && (
                                <View>
                                    ...
                                    <View>
                                        <Text style={styles.syllabusHeader}>Course Details of {this.state.fourSyllabus ? this.state.fourSyllabus[0].course_name : ''}</Text>
                                        <View style={styles.syllabus}>
                                            <Text style={styles.syllabusText}>Class duration : <Text style={styles.boldText}>{this.state.fourSyllabus ? this.state.fourSyllabus[0].course_duration : ''} hrs.</Text></Text>
                                            <Text style={styles.syllabusText}>Course amount: : <Text style={styles.boldText}>${this.state.fourSyllabus ? this.state.fourSyllabus[0].total_amount : ''}</Text></Text>
                                            <Text style={styles.syllabusText}>Number of classes : <Text style={styles.boldText}>{this.state.fourSyllabus ? this.state.fourSyllabus[0].Number_of_classes : ''}</Text></Text>
...
export default connect(mapStateToProps, null,)(withNavigation(OnlineCodingClasses));