...
class EmployeeFilterScreen extends Component {
  constructor() {
    super();
    this.state = {
      category: [{optn: 'Software Development'},{optn: 'Online Coding'},{optn: 'Homework'},{optn: 'Design'},{optn: 'Launuage'},{optn: 'Music & Arts'}, {optn: 'Fitness'}],
