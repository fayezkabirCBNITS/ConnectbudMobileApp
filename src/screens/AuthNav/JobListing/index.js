...
import { View, Text, SafeAreaView, TouchableOpacity, Image, TextInput, Modal, KeyboardAvoidingView } from 'react-native';
              ...
              <View style={{width: '100%', marginVertical: 20}}>
                ...
                <View style={styles.skillView}>
                  <View style={[styles.formGroup01]}>
                    <View style={styles.formPicker}>
                      <Picker
                        style={{ width: '100%', height: 55, color: '#000', fontFamily: 'Poppins-Regular', marginTop: -79 }}
                ...
                <View style={styles.skillView1}>
                  <View style={[styles.formGroup1]}>
                    <Picker
                      style={{ width: '100%', height: 45, color: '#3B1D25', marginTop: -85 }}
