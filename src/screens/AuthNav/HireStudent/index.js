                      ...
                      return (
                        <View style={styles.inputCard}>
                          ...
                          <View style={styles.wrap}>
                            ...
                            {/* <TouchableOpacity
                              style={styles.date}
                              onPress={this.showDateTimePickerMilestone(index)}>
                                <Text>{this.state.JobExpiry}</Text>
                                <View style={{position:"absolute",right:15}}>
                                <FontAwesome name="calendar" size={30} color="#71b85f" />
                                </View>
                            </TouchableOpacity>
                            <DateTimePicker
                            isVisible={this.state.activeIndex?true:false}
                            mode="date"
                            onConfirm={(date) => this.setState({JobExpiry :  moment(date).format("DD-MM-yyyy")})}
