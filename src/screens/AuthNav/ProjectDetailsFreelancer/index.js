                    ...
                    <View style={[CommonStyles.container, styles.bgColorWhite]}>
                        <ScrollView style={styles.scrolling} showsVerticalScrollIndicator={false}>
                            <View style={styles.boxWrapper}>
                                <Text style={styles.boxTitle}>Introduction to Html5 and css3</Text>
                                <Text style={styles.daysAgo}>13 days ago</Text>
                                <Text style={styles.courseDetails}>Course Details</Text>
                                <Text>
                                    <Text style={styles.textSemibold}> Course Amount : </Text> <Text> 20 USD</Text>
                                </Text>
                                <Text>
                                    <Text style={styles.textSemibold}> Course Duration : </Text> <Text></Text> month
                                </Text>
                                <Text>
                                    <Text style={styles.textSemibold}> Course Date : </Text> <Text>2020-12-16</Text>
                                </Text>
                                <Text>
                                    <Text style={styles.textSemibold}> Course Syllabus : </Text>
                                    <Text style={styles.syllabusText}>est et sapien ullamcorper pharetra. Vestibulum erat wisi, condimentum sed, commodo vitae, ornare sit amet, wisi. Aenean fermentum, elit eget tincidunt condimentum, eros ipsum rutrum orci, sagittis tempus</Text>
                                </Text>
                            ...
                            <View style={styles.similarJobWrapper}>
                                <View style={styles.slimilarJob}>
                                    <Text style={styles.similiarjobText}>Similar Jobs for me</Text>
                                </View>
                                {
                                    new Array(6).fill({ fill: "fill" }).map((data, idx) => (
                                        <View key={idx} style={styles.similarList}>
                                            <View style={styles.iconList}>
                                                <FontAwesome style={{ width: 30 }} name="graduation-cap" size={15} color="#d7d7d8" />
                                                <Text style={styles.iconText}>Security Testing</Text>
                                            </View>
                                            <View style={styles.iconList}>
                                                <FontAwesome style={{ width: 30 }} name="tag" size={15} color="#d7d7d8" />
                                                <Text style={styles.iconText}>0 out of 1 skillset matched</Text>
                                            </View>
                                        </View>
                                    ))
                                }
