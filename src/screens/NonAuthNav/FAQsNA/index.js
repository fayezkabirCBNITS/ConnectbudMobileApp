      ...
      list: [
        {
          id: 1,
          title:
            'Can students directly register into the ConnectBud platform or they need to come through TPO?',
          body:
            'Students can directly register to ConnectBud platform by using their college email address. For the students who do not have college email address, they can ask their college officials to have their college onboard to ConnectBud platform and upload the personal student email IDs to ConnectBud database.',
        },
        {
          id: 2,
          title:
            'How do you validate that only genuine students become part of the platform?',
          body:
        ...
        },
        {
          id: 3,
          title:
            'Is there any fees to register to the platform for student or for the folks who want to post project?',
          body:
            'No. ConnectBud platform is ABSOLUTELY FREE TO USE for both, the college students and the employers. There are no registration fees or other hidden charges.',
        },
        {
          id: 4,
          title: 'If I want to put internship job, can I post it?',
          body:
            'It is very simple to put internship jobs on ConnectBud. For posting internship jobs, go to the “Recruiters” section of the website, log in with your email, fill out the project details section, and publish internship job.',
        },
        {
          id: 5,
          title: 'Is there any certificate given for the projects done?',
          body:
            'Yes, ConnectBud provides certificates to the college students after the successful completion of the projects.',
        },
        {
          id: 6,
          title: 'Are the projects on the platform paid?',
          body:
            'All the posted projects on the ConnectBud platform are paid with the amount of money clearly stated in the price box.',
        },
        {
          id: 7,
          title:
            'I dont have a valid college domain email address, can I still register?',
          body:
            'Of course, if you are a current student you can register to ConnectBud without a valid college domain email address. Contact your college officials to onboard the name of the college to the ConnectBud platform and upload your email address to our database, and you’ll be able to use the platform for cashing in freelancing opportunities.',
        },
        {
          id: 8,
          title:
            'If I have additional questions, which email address should I send my queries to?',
          ...
          <ScrollView showsVerticalScrollIndicator={false} style={styles.scroll}>
            <View style={styles.mainContainer}>
              ...
              <Text style={styles.subHeadText}>
                We are sharing some of our most frequently asked questions to
                help you out
              </Text>
              <View>
